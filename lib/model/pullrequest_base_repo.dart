...
class PullrequestBaseRepo {
  ...
  AllOfpullrequestBaseRepoLicense license = null;
  ...
  PullrequestBaseRepo.fromJson(Map<String, dynamic> json) {
    ...
    license = new AllOfpullrequestBaseRepoLicense.fromJson(json['license']);
  ...
  static List<PullrequestBaseRepo> listFromJson(List<dynamic> json) {
    return json == null ? new List<PullrequestBaseRepo>() : json.map((value) => new PullrequestBaseRepo.fromJson(value)).toList();
  }

  static Map<String, PullrequestBaseRepo> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PullrequestBaseRepo>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new PullrequestBaseRepo.fromJson(value));
    }
    return map;
  }
}
