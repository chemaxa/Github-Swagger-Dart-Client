...
/* The number of installations associated with the GitHub app */
  ...
  static List<AllOfcheckRunApp> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcheckRunApp>() : json.map((value) => new AllOfcheckRunApp.fromJson(value)).toList();
  }

  static Map<String, AllOfcheckRunApp> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcheckRunApp>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcheckRunApp.fromJson(value));
    }
    return map;
  }
}
