...
class AllOfissueEventAssignee {
  ...
  static List<AllOfissueEventAssignee> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueEventAssignee>() : json.map((value) => new AllOfissueEventAssignee.fromJson(value)).toList();
  }

  static Map<String, AllOfissueEventAssignee> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueEventAssignee>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueEventAssignee.fromJson(value));
    }
    return map;
  }
}
