...
class AllOfissueAssignee {
  ...
  static List<AllOfissueAssignee> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueAssignee>() : json.map((value) => new AllOfissueAssignee.fromJson(value)).toList();
  }

  static Map<String, AllOfissueAssignee> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueAssignee>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueAssignee.fromJson(value));
    }
    return map;
  }
}
