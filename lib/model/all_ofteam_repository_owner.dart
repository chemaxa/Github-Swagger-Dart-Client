...
class AllOfteamRepositoryOwner {
  ...
  static List<AllOfteamRepositoryOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfteamRepositoryOwner>() : json.map((value) => new AllOfteamRepositoryOwner.fromJson(value)).toList();
  }

  static Map<String, AllOfteamRepositoryOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfteamRepositoryOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfteamRepositoryOwner.fromJson(value));
    }
    return map;
  }
}
