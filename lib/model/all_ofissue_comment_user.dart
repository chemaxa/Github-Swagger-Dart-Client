...
class AllOfissueCommentUser {
  ...
  static List<AllOfissueCommentUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueCommentUser>() : json.map((value) => new AllOfissueCommentUser.fromJson(value)).toList();
  }

  static Map<String, AllOfissueCommentUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueCommentUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueCommentUser.fromJson(value));
    }
    return map;
  }
}
