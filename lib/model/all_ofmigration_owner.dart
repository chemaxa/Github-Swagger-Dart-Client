...
class AllOfmigrationOwner {
  ...
  static List<AllOfmigrationOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfmigrationOwner>() : json.map((value) => new AllOfmigrationOwner.fromJson(value)).toList();
  }

  static Map<String, AllOfmigrationOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfmigrationOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfmigrationOwner.fromJson(value));
    }
    return map;
  }
}
