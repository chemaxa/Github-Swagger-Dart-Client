...
class AllOforgMembershipUser {
  ...
  static List<AllOforgMembershipUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOforgMembershipUser>() : json.map((value) => new AllOforgMembershipUser.fromJson(value)).toList();
  }

  static Map<String, AllOforgMembershipUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOforgMembershipUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOforgMembershipUser.fromJson(value));
    }
    return map;
  }
}
