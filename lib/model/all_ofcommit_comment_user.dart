...
class AllOfcommitCommentUser {
  ...
  static List<AllOfcommitCommentUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcommitCommentUser>() : json.map((value) => new AllOfcommitCommentUser.fromJson(value)).toList();
  }

  static Map<String, AllOfcommitCommentUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcommitCommentUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcommitCommentUser.fromJson(value));
    }
    return map;
  }
}
