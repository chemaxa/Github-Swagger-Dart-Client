...
class AllOfissueEventReviewRequester {
  ...
  static List<AllOfissueEventReviewRequester> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueEventReviewRequester>() : json.map((value) => new AllOfissueEventReviewRequester.fromJson(value)).toList();
  }

  static Map<String, AllOfissueEventReviewRequester> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueEventReviewRequester>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueEventReviewRequester.fromJson(value));
    }
    return map;
  }
}
