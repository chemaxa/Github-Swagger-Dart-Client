...
class AllOfissueEventActor {
  ...
  static List<AllOfissueEventActor> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueEventActor>() : json.map((value) => new AllOfissueEventActor.fromJson(value)).toList();
  }

  static Map<String, AllOfissueEventActor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueEventActor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueEventActor.fromJson(value));
    }
    return map;
  }
}
