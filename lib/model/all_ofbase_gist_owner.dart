...
class AllOfbaseGistOwner {
  ...
  static List<AllOfbaseGistOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfbaseGistOwner>() : json.map((value) => new AllOfbaseGistOwner.fromJson(value)).toList();
  }

  static Map<String, AllOfbaseGistOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfbaseGistOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfbaseGistOwner.fromJson(value));
    }
    return map;
  }
}
