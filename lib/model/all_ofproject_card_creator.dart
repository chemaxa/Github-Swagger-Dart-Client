...
class AllOfprojectCardCreator {
  ...
  static List<AllOfprojectCardCreator> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfprojectCardCreator>() : json.map((value) => new AllOfprojectCardCreator.fromJson(value)).toList();
  }

  static Map<String, AllOfprojectCardCreator> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfprojectCardCreator>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfprojectCardCreator.fromJson(value));
    }
    return map;
  }
}
