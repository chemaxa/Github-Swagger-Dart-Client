...
/* The number of installations associated with the GitHub app */
  ...
  static List<AllOfcheckSuiteApp> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcheckSuiteApp>() : json.map((value) => new AllOfcheckSuiteApp.fromJson(value)).toList();
  }

  static Map<String, AllOfcheckSuiteApp> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcheckSuiteApp>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcheckSuiteApp.fromJson(value));
    }
    return map;
  }
}
