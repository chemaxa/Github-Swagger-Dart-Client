...
class AllOfprojectCreator {
  ...
  static List<AllOfprojectCreator> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfprojectCreator>() : json.map((value) => new AllOfprojectCreator.fromJson(value)).toList();
  }

  static Map<String, AllOfprojectCreator> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfprojectCreator>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfprojectCreator.fromJson(value));
    }
    return map;
  }
}
