...
class AllOfteamDiscussionAuthor {
  ...
  static List<AllOfteamDiscussionAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfteamDiscussionAuthor>() : json.map((value) => new AllOfteamDiscussionAuthor.fromJson(value)).toList();
  }

  static Map<String, AllOfteamDiscussionAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfteamDiscussionAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfteamDiscussionAuthor.fromJson(value));
    }
    return map;
  }
}
