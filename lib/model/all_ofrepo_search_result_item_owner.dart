...
class AllOfrepoSearchResultItemOwner {
  ...
  static List<AllOfrepoSearchResultItemOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfrepoSearchResultItemOwner>() : json.map((value) => new AllOfrepoSearchResultItemOwner.fromJson(value)).toList();
  }

  static Map<String, AllOfrepoSearchResultItemOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfrepoSearchResultItemOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfrepoSearchResultItemOwner.fromJson(value));
    }
    return map;
  }
}
