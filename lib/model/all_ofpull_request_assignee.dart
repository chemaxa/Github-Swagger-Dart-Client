...
class AllOfpullRequestAssignee {
  ...
  static List<AllOfpullRequestAssignee> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpullRequestAssignee>() : json.map((value) => new AllOfpullRequestAssignee.fromJson(value)).toList();
  }

  static Map<String, AllOfpullRequestAssignee> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpullRequestAssignee>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpullRequestAssignee.fromJson(value));
    }
    return map;
  }
}
