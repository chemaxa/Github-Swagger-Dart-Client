...
class AllOfauthorizationUser {
  ...
  static List<AllOfauthorizationUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfauthorizationUser>() : json.map((value) => new AllOfauthorizationUser.fromJson(value)).toList();
  }

  static Map<String, AllOfauthorizationUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfauthorizationUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfauthorizationUser.fromJson(value));
    }
    return map;
  }
}
