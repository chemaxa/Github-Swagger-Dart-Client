...
class AllOfcommitSearchResultItemAuthor {
  ...
  static List<AllOfcommitSearchResultItemAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcommitSearchResultItemAuthor>() : json.map((value) => new AllOfcommitSearchResultItemAuthor.fromJson(value)).toList();
  }

  static Map<String, AllOfcommitSearchResultItemAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcommitSearchResultItemAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcommitSearchResultItemAuthor.fromJson(value));
    }
    return map;
  }
}
