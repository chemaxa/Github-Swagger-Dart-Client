...
class AllOfdeploymentStatusCreator {
  ...
  static List<AllOfdeploymentStatusCreator> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfdeploymentStatusCreator>() : json.map((value) => new AllOfdeploymentStatusCreator.fromJson(value)).toList();
  }

  static Map<String, AllOfdeploymentStatusCreator> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfdeploymentStatusCreator>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfdeploymentStatusCreator.fromJson(value));
    }
    return map;
  }
}
