...
class AllOfdeploymentCreator {
  ...
  static List<AllOfdeploymentCreator> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfdeploymentCreator>() : json.map((value) => new AllOfdeploymentCreator.fromJson(value)).toList();
  }

  static Map<String, AllOfdeploymentCreator> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfdeploymentCreator>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfdeploymentCreator.fromJson(value));
    }
    return map;
  }
}
