...
class AllOfissueUser {
  ...
  static List<AllOfissueUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueUser>() : json.map((value) => new AllOfissueUser.fromJson(value)).toList();
  }

  static Map<String, AllOfissueUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueUser.fromJson(value));
    }
    return map;
  }
}
