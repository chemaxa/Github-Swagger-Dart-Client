...
class AllOfissueEventAssigner {
  ...
  static List<AllOfissueEventAssigner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueEventAssigner>() : json.map((value) => new AllOfissueEventAssigner.fromJson(value)).toList();
  }

  static Map<String, AllOfissueEventAssigner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueEventAssigner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueEventAssigner.fromJson(value));
    }
    return map;
  }
}
