...
class AllOfissueEventRequestedReviewer {
  ...
  static List<AllOfissueEventRequestedReviewer> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueEventRequestedReviewer>() : json.map((value) => new AllOfissueEventRequestedReviewer.fromJson(value)).toList();
  }

  static Map<String, AllOfissueEventRequestedReviewer> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueEventRequestedReviewer>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueEventRequestedReviewer.fromJson(value));
    }
    return map;
  }
}
