...
class AllOfbaseGistUser {
  ...
  static List<AllOfbaseGistUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfbaseGistUser>() : json.map((value) => new AllOfbaseGistUser.fromJson(value)).toList();
  }

  static Map<String, AllOfbaseGistUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfbaseGistUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfbaseGistUser.fromJson(value));
    }
    return map;
  }
}
