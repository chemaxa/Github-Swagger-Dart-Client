...
class AllOfapplicationGrantUser {
  ...
  static List<AllOfapplicationGrantUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfapplicationGrantUser>() : json.map((value) => new AllOfapplicationGrantUser.fromJson(value)).toList();
  }

  static Map<String, AllOfapplicationGrantUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfapplicationGrantUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfapplicationGrantUser.fromJson(value));
    }
    return map;
  }
}
