...
class AllOfissueSimpleAssignee {
  ...
  static List<AllOfissueSimpleAssignee> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueSimpleAssignee>() : json.map((value) => new AllOfissueSimpleAssignee.fromJson(value)).toList();
  }

  static Map<String, AllOfissueSimpleAssignee> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueSimpleAssignee>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueSimpleAssignee.fromJson(value));
    }
    return map;
  }
}
