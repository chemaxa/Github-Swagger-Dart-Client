...
class AllOfrepositoryInvitationInvitee {
  ...
  static List<AllOfrepositoryInvitationInvitee> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfrepositoryInvitationInvitee>() : json.map((value) => new AllOfrepositoryInvitationInvitee.fromJson(value)).toList();
  }

  static Map<String, AllOfrepositoryInvitationInvitee> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfrepositoryInvitationInvitee>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfrepositoryInvitationInvitee.fromJson(value));
    }
    return map;
  }
}
