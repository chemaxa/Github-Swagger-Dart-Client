...
class AllOfpullRequestSimpleAssignee {
  ...
  static List<AllOfpullRequestSimpleAssignee> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpullRequestSimpleAssignee>() : json.map((value) => new AllOfpullRequestSimpleAssignee.fromJson(value)).toList();
  }

  static Map<String, AllOfpullRequestSimpleAssignee> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpullRequestSimpleAssignee>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpullRequestSimpleAssignee.fromJson(value));
    }
    return map;
  }
}
