...
class AllOfreactionUser {
  ...
  static List<AllOfreactionUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfreactionUser>() : json.map((value) => new AllOfreactionUser.fromJson(value)).toList();
  }

  static Map<String, AllOfreactionUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfreactionUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfreactionUser.fromJson(value));
    }
    return map;
  }
}
