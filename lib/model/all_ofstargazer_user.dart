...
class AllOfstargazerUser {
  ...
  static List<AllOfstargazerUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfstargazerUser>() : json.map((value) => new AllOfstargazerUser.fromJson(value)).toList();
  }

  static Map<String, AllOfstargazerUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfstargazerUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfstargazerUser.fromJson(value));
    }
    return map;
  }
}
