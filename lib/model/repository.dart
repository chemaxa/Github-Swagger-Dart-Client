...
/* The name of the repository. */
  ...
  AllOfrepositoryLicense license = null;

  int forks = null;

  RepositoryPermissions permissions = null;

  AllOfrepositoryOwner owner = null;
...
/* Whether to allow merge commits for pull requests. */
  ...
  Repository.fromJson(Map<String, dynamic> json) {
    ...
    license = new AllOfrepositoryLicense.fromJson(json['license']);
    forks = json['forks'];
    permissions = new RepositoryPermissions.fromJson(json['permissions']);
    owner = new AllOfrepositoryOwner.fromJson(json['owner']);
