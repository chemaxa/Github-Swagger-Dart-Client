...
class AllOffullRepositoryOrganization {
  ...
  static List<AllOffullRepositoryOrganization> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOffullRepositoryOrganization>() : json.map((value) => new AllOffullRepositoryOrganization.fromJson(value)).toList();
  }

  static Map<String, AllOffullRepositoryOrganization> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOffullRepositoryOrganization>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOffullRepositoryOrganization.fromJson(value));
    }
    return map;
  }
}
