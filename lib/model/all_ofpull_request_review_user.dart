...
class AllOfpullRequestReviewUser {
  ...
  static List<AllOfpullRequestReviewUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpullRequestReviewUser>() : json.map((value) => new AllOfpullRequestReviewUser.fromJson(value)).toList();
  }

  static Map<String, AllOfpullRequestReviewUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpullRequestReviewUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpullRequestReviewUser.fromJson(value));
    }
    return map;
  }
}
