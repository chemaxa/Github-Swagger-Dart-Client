...
class AllOfinstallationSuspendedBy {
  ...
  static List<AllOfinstallationSuspendedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfinstallationSuspendedBy>() : json.map((value) => new AllOfinstallationSuspendedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfinstallationSuspendedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfinstallationSuspendedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfinstallationSuspendedBy.fromJson(value));
    }
    return map;
  }
}
