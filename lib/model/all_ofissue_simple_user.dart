...
class AllOfissueSimpleUser {
  ...
  static List<AllOfissueSimpleUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueSimpleUser>() : json.map((value) => new AllOfissueSimpleUser.fromJson(value)).toList();
  }

  static Map<String, AllOfissueSimpleUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueSimpleUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueSimpleUser.fromJson(value));
    }
    return map;
  }
}
