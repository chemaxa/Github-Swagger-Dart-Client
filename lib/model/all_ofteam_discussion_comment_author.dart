...
class AllOfteamDiscussionCommentAuthor {
  ...
  static List<AllOfteamDiscussionCommentAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfteamDiscussionCommentAuthor>() : json.map((value) => new AllOfteamDiscussionCommentAuthor.fromJson(value)).toList();
  }

  static Map<String, AllOfteamDiscussionCommentAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfteamDiscussionCommentAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfteamDiscussionCommentAuthor.fromJson(value));
    }
    return map;
  }
}
