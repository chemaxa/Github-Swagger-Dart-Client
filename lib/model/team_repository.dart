...
/* The name of the repository. */
  ...
  AllOfteamRepositoryLicense license = null;

  int forks = null;

  RepositoryPermissions permissions = null;

  AllOfteamRepositoryOwner owner = null;
...
/* Whether to allow merge commits for pull requests. */
  ...
  TeamRepository.fromJson(Map<String, dynamic> json) {
    ...
    license = new AllOfteamRepositoryLicense.fromJson(json['license']);
    forks = json['forks'];
    permissions = new RepositoryPermissions.fromJson(json['permissions']);
    owner = new AllOfteamRepositoryOwner.fromJson(json['owner']);
  ...
  static List<TeamRepository> listFromJson(List<dynamic> json) {
    return json == null ? new List<TeamRepository>() : json.map((value) => new TeamRepository.fromJson(value)).toList();
  }

  static Map<String, TeamRepository> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, TeamRepository>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new TeamRepository.fromJson(value));
    }
    return map;
  }
}
