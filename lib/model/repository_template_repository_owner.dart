...
class RepositoryTemplateRepositoryOwner {
  ...
  static List<RepositoryTemplateRepositoryOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<RepositoryTemplateRepositoryOwner>() : json.map((value) => new RepositoryTemplateRepositoryOwner.fromJson(value)).toList();
  }

  static Map<String, RepositoryTemplateRepositoryOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, RepositoryTemplateRepositoryOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new RepositoryTemplateRepositoryOwner.fromJson(value));
    }
    return map;
  }
}
