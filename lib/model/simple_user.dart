...
class SimpleUser {
  ...
  static List<SimpleUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<SimpleUser>() : json.map((value) => new SimpleUser.fromJson(value)).toList();
  }

  static Map<String, SimpleUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, SimpleUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new SimpleUser.fromJson(value));
    }
    return map;
  }
}
