...
class AllOfpageBuildPusher {
  ...
  static List<AllOfpageBuildPusher> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpageBuildPusher>() : json.map((value) => new AllOfpageBuildPusher.fromJson(value)).toList();
  }

  static Map<String, AllOfpageBuildPusher> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpageBuildPusher>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpageBuildPusher.fromJson(value));
    }
    return map;
  }
}
