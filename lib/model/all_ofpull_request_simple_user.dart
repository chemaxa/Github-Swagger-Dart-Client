...
class AllOfpullRequestSimpleUser {
  ...
  static List<AllOfpullRequestSimpleUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpullRequestSimpleUser>() : json.map((value) => new AllOfpullRequestSimpleUser.fromJson(value)).toList();
  }

  static Map<String, AllOfpullRequestSimpleUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpullRequestSimpleUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpullRequestSimpleUser.fromJson(value));
    }
    return map;
  }
}
