...
class AllOfgistCommentUser {
  ...
  static List<AllOfgistCommentUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfgistCommentUser>() : json.map((value) => new AllOfgistCommentUser.fromJson(value)).toList();
  }

  static Map<String, AllOfgistCommentUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfgistCommentUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfgistCommentUser.fromJson(value));
    }
    return map;
  }
}
