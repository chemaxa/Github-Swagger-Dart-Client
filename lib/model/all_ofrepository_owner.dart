...
class AllOfrepositoryOwner {
  ...
  static List<AllOfrepositoryOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfrepositoryOwner>() : json.map((value) => new AllOfrepositoryOwner.fromJson(value)).toList();
  }

  static Map<String, AllOfrepositoryOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfrepositoryOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfrepositoryOwner.fromJson(value));
    }
    return map;
  }
}
