...
class AllOffullRepositoryOwner {
  ...
  static List<AllOffullRepositoryOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOffullRepositoryOwner>() : json.map((value) => new AllOffullRepositoryOwner.fromJson(value)).toList();
  }

  static Map<String, AllOffullRepositoryOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOffullRepositoryOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOffullRepositoryOwner.fromJson(value));
    }
    return map;
  }
}
