...
class AllOfmilestoneCreator {
  ...
  static List<AllOfmilestoneCreator> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfmilestoneCreator>() : json.map((value) => new AllOfmilestoneCreator.fromJson(value)).toList();
  }

  static Map<String, AllOfmilestoneCreator> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfmilestoneCreator>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfmilestoneCreator.fromJson(value));
    }
    return map;
  }
}
