...
class MinimalRepository {
  ...
  AllOfminimalRepositoryOwner owner = null;
  ...
  MinimalRepository.fromJson(Map<String, dynamic> json) {
    ...
    owner = new AllOfminimalRepositoryOwner.fromJson(json['owner']);
    ...
    license = new MinimalrepositoryLicense.fromJson(json['license']);
    forks = json['forks'];
  ...
  static List<MinimalRepository> listFromJson(List<dynamic> json) {
    return json == null ? new List<MinimalRepository>() : json.map((value) => new MinimalRepository.fromJson(value)).toList();
  }

  static Map<String, MinimalRepository> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, MinimalRepository>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new MinimalRepository.fromJson(value));
    }
    return map;
  }
}
