...
class AllOfgistCommitUser {
  ...
  static List<AllOfgistCommitUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfgistCommitUser>() : json.map((value) => new AllOfgistCommitUser.fromJson(value)).toList();
  }

  static Map<String, AllOfgistCommitUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfgistCommitUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfgistCommitUser.fromJson(value));
    }
    return map;
  }
}
