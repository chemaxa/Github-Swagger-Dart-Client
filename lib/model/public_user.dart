...
class PublicUser {
  ...
  static List<PublicUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<PublicUser>() : json.map((value) => new PublicUser.fromJson(value)).toList();
  }

  static Map<String, PublicUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, PublicUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new PublicUser.fromJson(value));
    }
    return map;
  }
}
