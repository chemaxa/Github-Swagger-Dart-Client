...
class AllOfcommitCommitter {
  ...
  static List<AllOfcommitCommitter> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcommitCommitter>() : json.map((value) => new AllOfcommitCommitter.fromJson(value)).toList();
  }

  static Map<String, AllOfcommitCommitter> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcommitCommitter>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcommitCommitter.fromJson(value));
    }
    return map;
  }
}
