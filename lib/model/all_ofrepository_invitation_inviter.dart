...
class AllOfrepositoryInvitationInviter {
  ...
  static List<AllOfrepositoryInvitationInviter> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfrepositoryInvitationInviter>() : json.map((value) => new AllOfrepositoryInvitationInviter.fromJson(value)).toList();
  }

  static Map<String, AllOfrepositoryInvitationInviter> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfrepositoryInvitationInviter>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfrepositoryInvitationInviter.fromJson(value));
    }
    return map;
  }
}
