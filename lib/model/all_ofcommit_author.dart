...
class AllOfcommitAuthor {
  ...
  static List<AllOfcommitAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcommitAuthor>() : json.map((value) => new AllOfcommitAuthor.fromJson(value)).toList();
  }

  static Map<String, AllOfcommitAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcommitAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcommitAuthor.fromJson(value));
    }
    return map;
  }
}
