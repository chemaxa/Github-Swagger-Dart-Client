...
class AllOfreviewCommentUser {
  ...
  static List<AllOfreviewCommentUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfreviewCommentUser>() : json.map((value) => new AllOfreviewCommentUser.fromJson(value)).toList();
  }

  static Map<String, AllOfreviewCommentUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfreviewCommentUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfreviewCommentUser.fromJson(value));
    }
    return map;
  }
}
