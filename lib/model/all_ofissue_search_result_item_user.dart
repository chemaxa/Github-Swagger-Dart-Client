...
class AllOfissueSearchResultItemUser {
  ...
  static List<AllOfissueSearchResultItemUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueSearchResultItemUser>() : json.map((value) => new AllOfissueSearchResultItemUser.fromJson(value)).toList();
  }

  static Map<String, AllOfissueSearchResultItemUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueSearchResultItemUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueSearchResultItemUser.fromJson(value));
    }
    return map;
  }
}
