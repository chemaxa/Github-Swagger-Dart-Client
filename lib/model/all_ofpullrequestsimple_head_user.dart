...
class AllOfpullrequestsimpleHeadUser {
  ...
  static List<AllOfpullrequestsimpleHeadUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpullrequestsimpleHeadUser>() : json.map((value) => new AllOfpullrequestsimpleHeadUser.fromJson(value)).toList();
  }

  static Map<String, AllOfpullrequestsimpleHeadUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpullrequestsimpleHeadUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpullrequestsimpleHeadUser.fromJson(value));
    }
    return map;
  }
}
