...
class AllOfpullRequestMergedBy {
  ...
  static List<AllOfpullRequestMergedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfpullRequestMergedBy>() : json.map((value) => new AllOfpullRequestMergedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfpullRequestMergedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfpullRequestMergedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfpullRequestMergedBy.fromJson(value));
    }
    return map;
  }
}
