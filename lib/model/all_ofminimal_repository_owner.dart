...
class AllOfminimalRepositoryOwner {
  ...
  static List<AllOfminimalRepositoryOwner> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfminimalRepositoryOwner>() : json.map((value) => new AllOfminimalRepositoryOwner.fromJson(value)).toList();
  }

  static Map<String, AllOfminimalRepositoryOwner> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfminimalRepositoryOwner>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfminimalRepositoryOwner.fromJson(value));
    }
    return map;
  }
}
