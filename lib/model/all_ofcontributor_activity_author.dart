...
class AllOfcontributorActivityAuthor {
  ...
  static List<AllOfcontributorActivityAuthor> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfcontributorActivityAuthor>() : json.map((value) => new AllOfcontributorActivityAuthor.fromJson(value)).toList();
  }

  static Map<String, AllOfcontributorActivityAuthor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfcontributorActivityAuthor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfcontributorActivityAuthor.fromJson(value));
    }
    return map;
  }
}
