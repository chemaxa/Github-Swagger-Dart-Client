...
class AllOfissueClosedBy {
  ...
  static List<AllOfissueClosedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfissueClosedBy>() : json.map((value) => new AllOfissueClosedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfissueClosedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfissueClosedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfissueClosedBy.fromJson(value));
    }
    return map;
  }
}
