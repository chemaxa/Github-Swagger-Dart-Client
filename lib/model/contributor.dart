...
class Contributor {
  ...
  static Map<String, Contributor> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, Contributor>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new Contributor.fromJson(value));
    }
    return map;
  }
}
