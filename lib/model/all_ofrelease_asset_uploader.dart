...
class AllOfreleaseAssetUploader {
  ...
  static List<AllOfreleaseAssetUploader> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfreleaseAssetUploader>() : json.map((value) => new AllOfreleaseAssetUploader.fromJson(value)).toList();
  }

  static Map<String, AllOfreleaseAssetUploader> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfreleaseAssetUploader>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfreleaseAssetUploader.fromJson(value));
    }
    return map;
  }
}
