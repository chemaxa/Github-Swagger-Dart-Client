...
class LicensesApi {
  ...
  Future<License> licensesGet(String license) async {
    ...
    if(license == null) {
     throw new ApiException(400, "Missing required param: license");
    }
  ...
  Future<List<LicenseSimple>> licensesGetAllCommonlyUsed({ bool featured, int perPage }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
        (apiClient.deserialize(response.body, 'List<LicenseSimple>') as List).map((item) => item as LicenseSimple).toList();
    } else {
      return null;
    }
  }
  ...
  Future<LicenseContent> licensesGetForRepo(String owner, String repo) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'LicenseContent') as LicenseContent ;
    } else {
      return null;
    }
  }
