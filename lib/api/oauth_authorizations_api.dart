...
class OauthAuthorizationsApi {
  ...
  @deprecated
  Future<Authorization> oauthAuthorizationsCreateAuthorization({ Body6 body }) async {
  ...
  Future oauthAuthorizationsDeleteAuthorization(int authorizationId) async {
    ...
    if(authorizationId == null) {
     throw new ApiException(400, "Missing required param: authorizationId");
    }
  ...
  Future oauthAuthorizationsDeleteGrant(int grantId) async {
    ...
    // verify required params are set
    if(grantId == null) {
     throw new ApiException(400, "Missing required param: grantId");
    }
  ...
  Future<ApplicationGrant> oauthAuthorizationsGetGrant(int grantId) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'ApplicationGrant') as ApplicationGrant ;
    } else {
      return null;
    }
  }
  ...
  @deprecated
  Future<Authorization> oauthAuthorizationsGetOrCreateAuthorizationForApp(String clientId, { Body7 body }) async {
    Object postBody = body;
  ...
  @deprecated
  Future<Authorization> oauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint(String clientId, String fingerprint, { Body8 body }) async {
    Object postBody = body;
    ...
    if(fingerprint == null) {
     throw new ApiException(400, "Missing required param: fingerprint");
    }
  ...
  Future<List<Authorization>> oauthAuthorizationsListAuthorizations({ int perPage, int page }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
        (apiClient.deserialize(response.body, 'List<Authorization>') as List).map((item) => item as Authorization).toList();
    } else {
      return null;
    }
  }
  ...
  Future<List<ApplicationGrant>> oauthAuthorizationsListGrants({ int perPage, int page }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
        (apiClient.deserialize(response.body, 'List<ApplicationGrant>') as List).map((item) => item as ApplicationGrant).toList();
    } else {
      return null;
    }
  }
  ...
  @deprecated
  Future<Authorization> oauthAuthorizationsUpdateAuthorization(int authorizationId, { Body9 body }) async {
    Object postBody = body;
